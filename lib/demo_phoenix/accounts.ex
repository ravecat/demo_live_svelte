defmodule DemoPhoenix.Accounts do
  @moduledoc """
  ...
  alias DemoPhoenix.Accounts.{User, UserToken, UserNotifier}
  ...
  See `DemoPhoenix.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `DemoPhoenix.Accounts.User.password_changeset/3` for a list of supported options.
