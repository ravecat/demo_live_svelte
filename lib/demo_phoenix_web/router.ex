defmodule DemoPhoenixWeb.Router do
  ...
  import DemoPhoenixWeb.UserAuth
  ...
  if Application.compile_env(:demo_phoenix, :dev_routes) do
  ...
  scope "/", DemoPhoenixWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{DemoPhoenixWeb.UserAuth, :require_authenticated}] do
  ...
  scope "/", DemoPhoenixWeb do
    ...
    live_session :current_user,
      on_mount: [{DemoPhoenixWeb.UserAuth, :mount_current_scope}] do
